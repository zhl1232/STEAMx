...
| `ldraw-models/3-gang-qin.ldr`, `3-hua-hua-ti.ldr`, `3-hua-jiao.ldr` | 3+ 课件第 44「钢琴」、52「滑滑梯」、53「花轿」的得宝件限定 LDraw 源草稿；仅用于后续人工 Studio/PDF 修复，**未**打包成 MPD、**未**挂载课程、**未**生成迁移；钢琴已由用户人工验证，后续批量修复跳过 |
