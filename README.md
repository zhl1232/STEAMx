...
基于项目学习（PBL）的 STEAMX · 史迪姆平台。

## 🎯 项目简介

STEAMX · 史迪姆是一个面向 3-16 岁儿童与青少年的互动学习社区，围绕科学实验、技术制作、工程搭建、艺术创作、数学思维和自然观察，通过项目式学习（PBL）驱动成长。
...
- **益智游乐场** — 18 个互动游戏，含五子棋、记忆翻牌与函数战争实时对战、10 款固定题面游戏的邀请竞速房间，以及扫雷云端榜单
