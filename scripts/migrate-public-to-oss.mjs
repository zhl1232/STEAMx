...
const GROUPS = [
  ...
  { id: 'birds-atlas', localDir: 'public/birds/atlas', publicPrefix: 'birds/atlas', manifest: null, kind: 'flat' },
  { id: 'insects-atlas', localDir: 'public/insects/atlas', publicPrefix: 'insects/atlas', manifest: null, kind: 'flat' },
  { id: 'trees-atlas', localDir: 'public/trees/atlas', publicPrefix: 'trees/atlas', manifest: null, kind: 'flat' },
  { id: 'fruits-atlas', localDir: 'public/fruits/atlas', publicPrefix: 'fruits/atlas', manifest: null, kind: 'flat' },
