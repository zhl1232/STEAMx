  ...
  return (
    <div className="page-shell pt-6 pb-24 md:pb-10">
      <div className="md:hidden">
        <MobilePageHeader title="物种" fallbackHref="/nature" />
      </div>

      <section className="surface-panel overflow-hidden">
        <div className="px-5 py-6 sm:px-7 sm:py-7 lg:px-8">
          <p className="section-kicker">自然观察</p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">物种</h1>
          ...
          <div className="mt-8 flex justify-end">
            {hasMore ? (
              <Link
                href={`/nature/species?page=${page + 1}${query ? `&q=${encodeURIComponent(query)}` : ""}`}
