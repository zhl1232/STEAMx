...
interface CommunityPageClientProps {
    ...
    initialDiscussionTotal: number | null;
    initialDiscussions: DiscussionListItem[];
    initialDiscussionsHasMore: boolean;
    initialDiscussionTags: string[];
    initialDiscussionDataLoaded: boolean;
    initialDiscussionTagsLoaded: boolean;
}

function CommunityPageContent({
    initialTab,
    initialDiscussionTotal,
    initialDiscussions,
    initialDiscussionsHasMore,
                    ...
                    >
                        {activeTab === "discussions" ? (
                            <DiscussionList
                                ...
                                initialHasMore={initialDiscussionsHasMore}
                                initialAvailableTags={initialDiscussionTags}
                                initialDataLoaded={initialDiscussionDataLoaded}
                                initialTagsLoaded={initialDiscussionTagsLoaded}
                            />
                        ) : (
                            <ChallengeBoard
