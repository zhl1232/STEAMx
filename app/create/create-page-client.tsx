...
function CreateHero() {
    return (
        <section className="relative isolate min-h-[220px] overflow-hidden rounded-[var(--radius-sm)] border border-[hsl(var(--surface-border)/0.68)] bg-[hsl(var(--surface-raised))] shadow-[0_24px_70px_-44px_hsl(var(--brand-blue)/0.28)] min-[390px]:min-h-[236px] md:min-h-[360px] lg:min-h-[374px]">
            <Image
                src={createHeroImage}
                alt="孩子们围坐在桌前调试机器人小车"
                fill
            ...
            <div className="relative z-10 flex min-h-[220px] flex-col justify-end p-5 text-white min-[390px]:min-h-[236px] md:min-h-[360px] md:justify-between md:px-8 md:py-9 md:text-foreground lg:min-h-[374px] lg:px-10">
                <div className="max-w-[20rem] md:max-w-[32rem]">
                    <p className="max-w-[16rem] text-[20px] font-black leading-[1.3] tracking-normal [text-shadow:0_2px_8px_rgba(0,0,0,0.78)] min-[390px]:max-w-[18rem] min-[390px]:text-[22px] md:max-w-[28rem] md:text-[28px] md:leading-[1.12] md:text-[hsl(var(--community-hero-fg))] md:[text-shadow:0_2px_10px_rgba(255,255,255,0.7)] md:dark:text-slate-50 md:dark:[text-shadow:0_2px_8px_rgba(0,0,0,0.82)]">
                        动手实践，探索创造的乐趣
                    </p>
