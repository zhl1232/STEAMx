...
import { useSudoku, type SudokuDifficulty } from "@/hooks/useSudoku"
                                ...
                                {status === "won" && (
                                    ...
                                    >
                                        <motion.div
                                            ...
                                            className="bg-background/95 px-6 py-5 sm:px-10 sm:py-8 rounded-3xl border border-primary/50 shadow-2xl flex flex-col items-center gap-3"
                                        >
