...
import { POST } from '@/app/api/replies/[id]/like/route'
...
describe('POST /api/replies/[id]/like', () => {
  ...
  it('returns 404 when the reply does not exist', async () => {
    ...
    const response = await POST(new Request('http://localhost/api/replies/404/like', {
      method: 'POST',
    }), {
