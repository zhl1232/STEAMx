...
export function PblInfo({ challenge }: PblInfoProps) {
  ...
  return (
    <div className="space-y-6">
      {challenge.scenario && (
        <div className="surface-subtle border-amber-200/70 bg-gradient-to-r from-amber-50/92 to-orange-50/88 p-6 dark:border-amber-800/60 dark:from-amber-950/24 dark:to-orange-950/20">
      ...
      {challenge.drivingQuestion && (
        <div className="surface-subtle border-blue-200/70 bg-gradient-to-r from-blue-50/92 to-indigo-50/88 p-6 dark:border-blue-800/60 dark:from-blue-950/24 dark:to-indigo-950/20">
          <div className="flex items-start gap-3">
