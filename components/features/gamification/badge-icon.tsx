...
const BronzeShape = ({ uid }: { uid: string }) => (
  <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full drop-shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:drop-shadow-xl">
    <defs>
      ...
      <linearGradient id={`bronze-glass-${uid}`} x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="white" stopOpacity="0.4" />
        <stop offset="50%" stopColor="white" stopOpacity="0" />
      </linearGradient>
    </defs>
    <circle cx="50" cy="50" r="48" fill={`url(#bronze-rim-${uid})`} />
    <circle cx="50" cy="50" r="42" fill={`url(#bronze-base-${uid})`} />
    <ellipse cx="50" cy="25" rx="30" ry="12" fill={`url(#bronze-glass-${uid})`} />
...
const SilverShape = ({ uid }: { uid: string }) => (
  <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full drop-shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:drop-shadow-xl">
    <defs>
      ...
      <linearGradient id={`silver-glass-${uid}`} x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="white" stopOpacity="0.5" />
        <stop offset="50%" stopColor="white" stopOpacity="0" />
      </linearGradient>
    </defs>
    <polygon points="50,2 91.5,26 91.5,74 50,98 8.5,74 8.5,26" fill={`url(#silver-rim-${uid})`} />
    <polygon points="50,8 86,29 86,71 50,92 14,71 14,29" fill={`url(#silver-base-${uid})`} />
    <polygon points="50,10 84,30 84,50 16,50 16,30" fill={`url(#silver-glass-${uid})`} opacity="0.6" />
...
const GoldShape = ({ uid }: { uid: string }) => (
  <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full drop-shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:drop-shadow-xl">
    <defs>
      ...
      <linearGradient id={`gold-glass-${uid}`} x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="white" stopOpacity="0.6" />
        <stop offset="40%" stopColor="white" stopOpacity="0" />
      </linearGradient>
    </defs>
    <path d="M10,20 L50,5 L90,20 C90,60 75,90 50,98 C25,90 10,60 10,20 Z" fill={`url(#gold-rim-${uid})`} />
    <path d="M16,25 L50,12 L84,25 C84,58 71,84 50,91 C29,84 16,58 16,25 Z" fill={`url(#gold-base-${uid})`} />
    <path d="M18,26 L50,14 L82,26 C82,45 78,55 50,55 C22,55 18,45 18,26 Z" fill={`url(#gold-glass-${uid})`} opacity="0.8" />
...
const PlatinumShape = ({ uid }: { uid: string }) => (
  <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full drop-shadow-[0_4px_12px_rgba(6,182,212,0.4)] transition-transform duration-500 group-hover:scale-110 group-hover:drop-shadow-[0_8px_20px_rgba(6,182,212,0.6)]">
    ...
    <polygon points="50,2 84,16 98,50 84,84 50,98 16,84 2,50 16,16" fill={`url(#plat-rim-${uid})`} />
    <polygon points="50,9 79,21 91,50 79,79 50,91 21,79 9,50 21,21" fill={`url(#plat-base-${uid})`} />
    ...
    <polygon points="50,11 77,23 89,50 11,50 23,23" fill={`url(#plat-glass-${uid})`} opacity="0.7" />
