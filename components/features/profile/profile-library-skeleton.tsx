...
function MobileProfileLibrarySkeleton() {
  return (
    <div className="flex min-h-screen flex-col bg-background pb-24 md:hidden">
      <div className="sticky top-[calc(var(--mobile-global-header-height,4rem)+env(safe-area-inset-top))] z-30 border-b border-border/70 bg-background/92 shadow-[0_1px_0_rgba(15,23,42,0.04)] backdrop-blur-md supports-[backdrop-filter]:bg-background/80">
