...
export function ProjectContinuationCard({ kind, href, project, compact = false, className }: ProjectContinuationCardProps) {
  ...
  return (
    <section className={cn(
      "overflow-hidden border border-border/70 bg-card/85 shadow-[0_18px_45px_-28px_rgba(15,23,42,0.22)] backdrop-blur-xs",
      compact ? "rounded-lg" : "rounded-xl",
      className,
    )}>
      <div className={cn(
        "border-b border-border/60 bg-linear-to-r from-primary/8 via-background to-secondary/20",
      ...
      <div className={compact ? "px-5 py-5" : "px-5 py-6 sm:px-7 sm:py-7"}>
        {project ? (
          <div className={cn(
            ...
            compact ? "rounded-md p-3.5" : "rounded-(--radius-lg) p-4 sm:p-5 md:grid-cols-[220px_minmax(0,1fr)]",
          )}>
            <div className={cn(
          ...
          <div className={cn(
            ...
            compact ? "rounded-md" : "rounded-(--radius-lg) sm:px-6",
          )}>
