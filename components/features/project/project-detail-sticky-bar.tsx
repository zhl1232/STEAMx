        ...
        <nav className="pointer-events-auto hidden shrink-0 items-center gap-1 xl:flex" aria-label="项目详情快捷导航">
          {[
            ...
            <button
              ...
              className="h-8 rounded-[8px] px-3 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted/70 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
              {label}
            </button>
          ))}
