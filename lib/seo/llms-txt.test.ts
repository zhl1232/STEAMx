...
describe("buildLlmsTxt", () => {
  it("describes the public site and keeps the production sitemap", () => {
    ...
    expect(text).toContain("STEAMX（史迪姆）给孩子做少儿编程、积木课和观鸟");
    expect(text).toContain("STEAMX is a Chinese children's platform for coding, brick building, and birdwatching. Kids build with their hands, go observe, and turn projects into works.");
