...
export function buildLlmsTxt() {
  ...
  return [
    ...
    SITE_DESCRIPTION,
    "",
    `${BRAND_NAME} is a Chinese children's platform for coding, brick building, and nature observation. Kids build with their hands, go observe, and turn projects into works.`,
    "",
    "## 主要公开栏目",
    "",
    `- 首页：${home}`,
