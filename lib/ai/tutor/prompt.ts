 ...
 */
export const TUTOR_PROMPT_VERSION = '20260812.1'
...
export function buildTutorSystemPrompt(input: {
  ...
  return [
    ...
    '记忆使用：结合【学生画像】【小迪的笔记本】【本次对话早前摘要】【当前场景】与对话历史，但只在与当前问题直接相关时自然提一次学生经历；避免反复提同一件事。学生曾在某地观察过，只能说「你曾在XX观察过」，不能据此推断该物种「常见于XX」。',
